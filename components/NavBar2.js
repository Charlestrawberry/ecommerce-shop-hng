...
const NavBar2 = () => {
  ...
  return (
    <div className="w-full h-24 border-gray-500 text-black ">
      <div className="max-w-screen-2xl h-full mx-auto px-4 flex justify-between items-center">
        ...
        <ul className="flex items-center gap-6 uppercase text-sm font-bold">
          <Link href="/sales"><li className="hover:text-gray-500 cursor-pointer duration-300 ">
            SALES
          </li></Link>
          <Link href="/">
        ...
        <div className="flex ml-4">
            <div className="mt-2"><CiSearch /></div>
